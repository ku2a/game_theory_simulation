...
to-report get-random-breed
  let total ( prop-goods + prop-bads + prop-rands + prop-tats + prop-inv-tats )
  show ( total )
...
to setup [num-goods num-bads num-rands num-tats num-invtats]
...
to go [n_iter]
  ...
  ask turtles[
    ...
    let hambre log (count(turtles)) 10
...
48
SETUP
setup goods-spawn bads-spawn rands-spawn tats-spawn inverse-tats-spawn
NIL
1
T
OBSERVER
...
"Inverse-tat" 1.0 0 -8630108 true "" "plot count(inverse-tats) / count(turtles)"
...
"pen-1" 1.0 0 -13840069 true "" "plot count goods"
"pen-2" 1.0 0 -8630108 true "" "plot count inverse-tats"
"pen-3" 1.0 0 -2064490 true "" "plot count tit-for-tats"
"pen-4" 1.0 0 -1184463 true "" "plot count randomizeds"
